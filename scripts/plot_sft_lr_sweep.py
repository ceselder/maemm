...
fig.suptitle("Held-out fidelity along training for each SFT learning rate, LoRA r64 (solid) vs full fine-tuning (dashed stars) "
             "(same 2M real-activation examples, OneCycle schedule; intermediate checkpoints are not annealed)", fontsize=10.5, y=0.995)
