...
then on) or after MAX_TRIES. Log ~/shared/overnight/fft_retry_driver.log; ids ~/shared/overnight/sft_fullft_100m_ids.json."""
import json, os, subprocess, time
import modal
P = os.path.expanduser("~/shared/overnight/sft_fullft_100m_ids.json"); LOG = os.path.expanduser("~/shared/overnight/fft_retry_driver.log")
RUN = "realact104m_fullft_b4096_lr1e-5"; MAX_TRIES = 8
