...
<div class="tldr"><b>TL;DR (live; A still training)</b> Both runs reach mean_all ≈ 0.41 (A best {bA['eval/mean_all']:.3f} @ {bA['ckpt_step']}, B best {bB['eval/mean_all']:.3f} @ {bB['ckpt_step']}).
...
Regenerated by scripts/plot_rl_ab.py.</div>
