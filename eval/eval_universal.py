...
Standalone:
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/root/pmx/helpers python SL/eval_universal.py \
        --adapter checkpoints/rl_1M_yolo2/step_105 --sae-path ... --maxacts-path ... \
        --out eval_universal.json --wandb pmx-eval
"""
import argparse
import json
import os
